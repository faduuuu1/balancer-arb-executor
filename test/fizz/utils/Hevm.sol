...
interface IHevm {
    ...
    // Places runtime code at an address. Needed because the contract under
    // test hardcodes the Balancer Vault address as a constant — the mock has
    // to live exactly there. Verified supported by medusa 1.5.1.
